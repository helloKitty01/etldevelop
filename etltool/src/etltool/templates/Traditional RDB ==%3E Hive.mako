...
<div class="span3">
    <div class="sidebar-nav">
        <ul class="nav nav-list">
            ...
            <li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> HDFS <==> Traditional RDB</a></li>
            <li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> Traditional RDB ==> Hive</a></li>
			<li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> Hive ==> Traditional</a></li>
			<li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> Local File System ==> HDFS</a></li>
			<li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> HDFS ==> Local File System</a></li>
			<li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> Local File System ==> HBase</a></li>
			<li><a href="/beeswax/create/create_table/default"><i class="fa fa-wrench"></i> HBase ==> Local File System</a></li>
        </ul>
    </div>
</div>
...
<div class="span9">
  <div class="card card-small" style="margin-top: 0">
    ...
    <div class="card-body">
      <p>
        <ul class="nav nav-pills">
          <li class="active"><a href="#step1" class="step">第 1 步：名称</a></li>
          <li><a href="#step2" class="step">第 2 步：记录格式</a></li>
          <li><a href="#step3" class="step">第 3 步：序列化</a></li>
          <li><a href="#step4" class="step">第 4 步：文件格式</a></li>
          <li><a href="#step5" class="step">步骤 5：位置</a></li>
          <li><a href="#step6" class="step">步骤 6：列</a></li>
        </ul>
      ...
      <div class="steps">
        ...
        <div id="step1" class="stepDetails">
            <fieldset>
                <div class="alert alert-info"><h3>创建表</h3>让我们从数据存储位置的名称和描述开始。</div>
                <div class="control-group">
                    
    <label for="table-name" class="control-label">表名</label>

                    <div class="controls">
                        

                    <input name="table-name" value="" type='text' placeholder='表名'  class=""  />
    ...
    <label for="table-comment" class="control-label">描述</label>

                    <div class="controls">
                        

                    <input name="table-comment" value="" type='text' placeholder='可选'  class=""  />

                        <p class="help-block">
                            Use a table comment to describe your table.  For example, note the data&#39;s provenance and any caveats users need to know.
                        </p>
                    </div>
                </div>
            </fieldset>
...
<option value="timestamp">timestamp</option>
    ...
    <input type="hidden" name="columns-0-_exists" value="True" id="id_columns-0-_exists" />
      ...
      <div class="form-actions" style="padding-left: 10px">
          ...
          <input id="submit" type="submit" name="create" class="btn btn-primary hide" value="创建表" />
      </div>
      </form>
      </p>
    </div>
